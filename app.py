...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown(
            '<div class="info-box">Client: <b>1100480354</b><br>'
            'Token: <b>Hardcoded</b> — update <code>DHAN_ACCESS_TOKEN</code> daily</div>',
            unsafe_allow_html=True,
        )
